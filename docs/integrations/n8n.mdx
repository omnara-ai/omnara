...
<Steps>
  <Step title="Add Credentials">
    ...
    2. Select **Omnara API**
    3. Enter your API key from [claude.omnara.com/dashboard](https://claude.omnara.com/dashboard)
  ...
  <Step title="Test It">
    Execute your workflow and check the [Omnara dashboard](https://claude.omnara.com/dashboard) for messages
  </Step>
</Steps>
