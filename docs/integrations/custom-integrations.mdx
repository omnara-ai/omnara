...
Sending an input does not grant tools, create an integration subscription or change a built-in
integration's interaction destination.
...
## Contribute a built-in integration
...
shared integration infrastructure. The repository's
