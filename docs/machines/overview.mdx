...
| --- | --- | --- |
| What it is | A computer you already have, registered by installing the daemon | Capacity provisioned on demand from Blaxel, Unikraft Cloud, Daytona, Modal, or boxd |
...
<CardGroup cols={2}>
  ...
  <Card title="Machine pools" icon="layer-group" href="/machines/pools">
    On-demand capacity from Blaxel, Unikraft, Daytona, Modal, or boxd
  </Card>
