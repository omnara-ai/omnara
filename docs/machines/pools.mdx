...
The setting belongs to the pool and cannot be weakened by a project grant or agent config. A pool administrator can disable it when creating or editing a custom pool.
