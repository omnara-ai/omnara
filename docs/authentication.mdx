...
2. Opens your browser to `https://claude.omnara.com/cli-auth`
...
<Steps>
  <Step title="Get Your API Key">
    1. Sign in to your account at [claude.omnara.com](https://claude.omnara.com)
    2. Navigate to **Account → API Keys** (bottom left of dashboard)
    3. Or visit directly: [claude.omnara.com/dashboard/api-keys](https://claude.omnara.com/dashboard/api-keys)
...
<Steps>
  ...
  <Step title="Browser Opens">
    URL includes port and state: `https://claude.omnara.com/cli-auth?port=12345&state=abc123...`
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Callback timeout">
    ...
    # 1. Visit https://claude.omnara.com/cli-auth
    # 2. Copy API key
