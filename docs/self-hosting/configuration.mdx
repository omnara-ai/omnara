...
uses a 64,000-token allowance; other formats omit the request allowance. See
[model output limits](/organization/model-providers) for provider requirements and
context budgeting.
