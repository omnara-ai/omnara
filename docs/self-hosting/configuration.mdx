...
`default_max_output_tokens` to use the model's capacity; omit `max_output_tokens`
when the capacity is unknown. See [model output limits](/organization/model-providers)
