...
| `OMNARA_WORKER_EVENT_WEBHOOK_CONCURRENCY` | Maximum event webhook deliveries in flight per worker process; each organization is limited to one eighth of this, rounded down, with a minimum of one | `128` | No |
