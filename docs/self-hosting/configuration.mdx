...
Inbox retention runs last in each core maintenance tick. Completed/failed
receipts remain for seven days after completion or failure, measured by the database clock.
...
reservations, and remain for seven days for diagnostics. See the
