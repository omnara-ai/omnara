...
Inbox retention runs last in each core maintenance tick. Completed/failed receipts
...
so two stalled passes can delay the next core tick by about ten seconds. Hard
