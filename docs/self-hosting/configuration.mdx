...
| --- | --- | --- | --- |
| `OMNARA_PUBLIC_URL` | Public app origin used in emails, browser links, OAuth callbacks, and installer URLs. Origin only, no path; HTTPS outside localhost. Set identically on API, worker, and maintenance. | — | Yes |
