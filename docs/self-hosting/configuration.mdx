...
default to a pool of 1–10 connections, a 30-minute connection lifetime, and
five minutes of lifetime jitter. Override these with `pool_*` settings in
`OMNARA_DATABASE_URL`, and budget connections across all service replicas.
