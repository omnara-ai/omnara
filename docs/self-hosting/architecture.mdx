...
**Memory filesystem** holds the current contents of memory files. API and workers share the same persistent filesystem: a local volume on one host, or a shared mount across hosts.
