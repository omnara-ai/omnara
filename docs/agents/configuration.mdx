...
Tools use immutable app-agent context established by a provider or scheduled
launch, or explicit complete destination arguments when unbound. Handler selection
