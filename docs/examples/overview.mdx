...
| [`testagent`](https://github.com/omnara-ai/omnara/tree/main/examples/testagent) | A terminal chat CLI against any config (`go run ./examples/testagent chat …`) | The raw conversation loop in Go: launch, stream, input, resolve — the smallest complete client |
