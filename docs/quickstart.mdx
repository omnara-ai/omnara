...
<Steps>
  ...
  <Step title="Authenticate">
    Run the CLI to trigger browser authentication:

    ```bash
    omnara --auth
    ```

    This opens your browser where you'll:
    1. Sign in to Omnara (or create an account)
    2. Authorize the CLI
    3. API key automatically saved to `~/.omnara/credentials.json`
  </Step>
  ...
  <Step title="Start Your Agent">
    ...
    Everything you do in the terminal is now synced to your [dashboard](https://omnara.com/dashboard) and mobile app.
  </Step>
