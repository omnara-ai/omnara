...
An integration supplies tools for taking actions, subscription types for receiving events,
and an interaction handler for presenting questions and approvals. Agent configs
