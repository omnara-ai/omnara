...
The choice persists for future questions and approvals; existing prompts keep their
captured destination. A new provider input can select its eligible handler automatically.
