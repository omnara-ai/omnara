...
You can also configure an [Event webhook](/agents/configuration#event-webhook) to trigger custom-tool execution when a `tool_call_update` arrives with `state: ready`.
</Tip>
