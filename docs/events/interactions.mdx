...
For an interaction routed to an app handler, list and resolve responses include
its captured `destination`. Its `app_id` and `integration_target_id`
...
message metadata. These fields describe app delivery; your application can
present interactions without them. See [Apps](/integrations/apps) for handler
configuration and app-specific behavior, or
