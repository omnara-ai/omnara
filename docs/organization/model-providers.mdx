...
<Tabs>
<Tab title="Console">
  In **Add models**, select the detected models you want, or click **Skip for now**. Omnara uses each detected provider model slug as the model's initial name, such as `gpt-5.6`. Agent YAML must use that exact name.
