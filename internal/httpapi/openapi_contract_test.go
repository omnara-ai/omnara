...
func TestOpenAPISpecialRouteContracts(t *testing.T) {
	...
	connectorOnlyMutations := map[string]bool{
		"post /channel-connector/apps/{integrationAppID}/control-events":                                                     true,
		...
		"post /channel-connector/apps/{integrationAppID}/installations/{integrationInstallID}/channel-definitions/publish":   true,
		"post /channel-connector/apps/{integrationAppID}/installations/{integrationInstallID}/workflows/deliver":             true,
		"post /channel-connector/events/claim-next":                                                                          true,
		"post /channel-connector/apps/{integrationAppID}/installations/{integrationInstallID}/events/{receiptID}/complete":   true,
...
func TestOpenAPINamePropertiesUseExplicitContracts(t *testing.T) {
	...
	exceptions := map[string]string{
		...
		"AgentChannel.name":                                    "",
		"AgentChannelSummary.name":                             "",
		"ChannelMessageAuthor.display_name":                    "",
		"ChannelReplyDestination.display_name":                 "",
		"CreateExternalIntegrationInstallRequest.display_name": "",
		"RegisterExternalChannelRequest.name":                  "",
		"RegisteredChannel.name":                               "",
		"IntegrationApp.name":                                  "",
		"IntegrationAppSummary.name":                           "",
		...
		"ChannelWorkflowAuthor.display_name":                   "",
		"ChannelRegistrationTarget.display_name":               "",
		"ChannelRegistrationParent.display_name":               "",
		...
		"CompleteGitHubConnectionRequest.repository_full_name": "",
		"GitHubSetupRepository.full_name":                      "", // Native owner/repository name, not an Omnara resource name.
		"IntegrationInstall.display_name":                      "",
