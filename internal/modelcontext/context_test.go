...
func (s *fakeContextStore) GetAgentCurrentChannelID(context.Context, uuid.UUID, uuid.UUID) (uuid.UUID, error) {
	return s.currentChannelID, nil
}

func (s *fakeContextStore) GetAgentChannelToolEligibility(
	context.Context,
	uuid.UUID, uuid.UUID) (integrationstore.AgentChannelToolEligibility, error) {
