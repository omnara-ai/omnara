...
const outputLimitNotice = "[Automatic Omnara harness notice] The preceding response reached its output limit and may be incomplete. This notice was generated by the harness, not the user."
