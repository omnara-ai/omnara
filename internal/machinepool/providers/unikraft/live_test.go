...
func TestUnikraftProviderLiveSmoke(t *testing.T) {
	...
	machineProvider, err := (Definition{}).NewProvider(
		...
		providers.RuntimeConfig{Omnara: providers.OmnaraURLs{APIURL: omnaraPublicURL + "/api/v1", InstallerURL: omnaraPublicURL + "/install/omnarad.sh"}, ProviderAuthToken: apiKey},
	)
	if err != nil {
