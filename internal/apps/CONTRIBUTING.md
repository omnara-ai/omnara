...
| Provider HTTP/socket protocol | `internal/apps/<provider>/` |
...
| App, subscription, workflow state, inbox and transport leases | `internal/storage/appstore` |
...
Use app terminology for hosted behavior. The older `/api/integrations/` callback
