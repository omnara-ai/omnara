...
func (GitHubAppInboxProvider) Expand(
	ctx context.Context, appSetup appstore.ProjectAppRecord, payload []byte,
...
func (GitHubAppInboxProvider) DownloadFile(
	_ context.Context, _ appstore.ProjectAppRecord, _ []byte, _ string,
) (AppInboxFile, error) {
...
func NormalizeGitHubAppEvent(
	...
	if appSetup.Provider != appstore.AppProviderGitHub {
...
func GitHubWebhookInstallationMatches(c appstore.ProjectAppRecord, event github.Webhook) bool {
	...
	return c.Provider == appstore.AppProviderGitHub && appErr == nil && installationErr == nil &&
