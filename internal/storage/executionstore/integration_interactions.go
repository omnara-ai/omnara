...
func sameInteractionDestination(a, b InteractionDestination) bool {
	return a.IntegrationType == b.IntegrationType && a.HandlerKey == b.HandlerKey &&
		a.IntegrationID == b.IntegrationID && a.IntegrationTargetID == b.IntegrationTargetID && a.Address == b.Address &&
...
func interactionArgsForOrigin(
	...
	scope, err := integrationdefinition.ParseConversation(provider, address.Kind, address.Ref)
	if err != nil {
		return nil, false
	}
