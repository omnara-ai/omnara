...
func TestProjectAppProviderIdentities(t *testing.T) {
	...
	input.Provider = AppProviderDiscord
...
func TestProjectAppDiscordOptionalConfig(t *testing.T) {
	input := ConfigureProjectAppInput{
		...
		Provider: AppProviderDiscord, AppID: uuid.New(), ExpectedSetupRevision: 1,
