...
func TestWebFetchToolResultContentRetainsFullExtractedContent(t *testing.T) {
	content := strings.Repeat("é", 30_005)
	...
	if !utf8.ValidString(text) || strings.Count(text, "é") != 30_005 {
		t.Fatalf(
