...
class TestAmpCLILocation(unittest.TestCase):
    ...
    def test_find_amp_cli_in_common_locations(self, mock_is_file, mock_exists, mock_which):
...
class TestGitTracking(unittest.TestCase):
    ...
    def test_init_git_tracking_no_commits(self, mock_run):
        ...
        self.assertTrue(self.wrapper.git_diff_enabled)
        self.assertEqual(self.wrapper.initial_git_hash, "4b825dc642cb6eb9a060e54bf8d69288fbee4904")  # Empty tree hash
