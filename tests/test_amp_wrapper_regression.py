...
from webhooks.amp_wrapper import AmpWrapper, MessageProcessor
...
class TestMemoryLeaks(unittest.TestCase):
    ...
    def test_buffer_growth_prevention(self):
        ...
        initial_size = len(self.wrapper.terminal_buffer)
        
        # Add large amount of data
        for i in range(1000):
            self.wrapper.terminal_buffer += f"Large output chunk {i} with lots of text\n"
...
class TestInfiniteLoopPrevention(unittest.TestCase):
    ...
    def test_response_processing_terminates(self):
        ...
        def process_with_timeout():
            ...
            if completion_detected and hasattr(self.wrapper, 'inference_started') and self.wrapper.inference_started:
...
class TestDuplicateMessagePrevention(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.wrapper.omnara_client_sync.send_message.return_value = mock_response
        self.wrapper.omnara_client_sync.send_user_message.return_value = None
    ...
    def test_web_ui_message_deduplication(self):
        ...
        self.assertEqual(len([msg for msg in processor.web_ui_messages if msg == "Duplicate"]), 1)
