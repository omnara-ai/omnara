...
class TestOmnaraAPIIntegration(unittest.TestCase):
    ...
    def test_queued_message_handling(self):
        ...
        expected_messages = self.api_fixtures['queued_messages_response']['queued_user_messages']
    ...
    def test_user_message_deduplication(self):
        ...
        user_messages = [msg for msg in self.mock_client.messages_sent 
...
class TestAsyncOperations(unittest.TestCase):
    ...
    def test_input_request_cancellation(self):
        ...
        async def run_test():
            # Mock cancellation
            self.mock_async_client.request_user_input.side_effect = asyncio.CancelledError()
