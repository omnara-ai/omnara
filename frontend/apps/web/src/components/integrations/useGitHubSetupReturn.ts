...
function readReturn() {
  ...
  else if (reason === 'integration_setup_changed')
    error = secret.success
      ? 'Integration setup changed while you were on GitHub. Your credential was saved. Review the current integration setup before connecting.'
