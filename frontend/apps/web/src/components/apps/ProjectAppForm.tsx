import { useUpdateProjectApp } from '@omnara/react'
...
export function ProjectAppForm(props: ProjectAppFormProps) {
  ...
  const stale = base.id !== props.app.id || base.updated_at !== props.app.updated_at
  return (
...
function ProjectAppFormEditor({
  ...
  async function submit(event: SyntheticEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const saved = await update.mutateAsync({ appID: app.id, ...request })
