 ...
 * List memory files
 *
 * List a directory's immediate children in name order. Omit path to list the store root.
 */
export const listMemoryFiles = <ThrowOnError extends boolean = true>(options: Options<ListMemoryFilesData, ThrowOnError>): RequestResult<ListMemoryFilesResponses, ListMemoryFilesErrors, ThrowOnError> => (options.client ?? client).get<ListMemoryFilesResponses, ListMemoryFilesErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListMemoryFilesResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 * Delete memory file
 */
export const deleteMemoryFile = <ThrowOnError extends boolean = true>(options: Options<DeleteMemoryFileData, ThrowOnError>): RequestResult<DeleteMemoryFileResponses, DeleteMemoryFileErrors, ThrowOnError> => (options.client ?? client).delete<DeleteMemoryFileResponses, DeleteMemoryFileErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zDeleteMemoryFileResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const downloadMemoryFile = <ThrowOnError extends boolean = true>(options: Options<DownloadMemoryFileData, ThrowOnError>): RequestResult<DownloadMemoryFileResponses, DownloadMemoryFileErrors, ThrowOnError> => (options.client ?? client).get<DownloadMemoryFileResponses, DownloadMemoryFileErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zDownloadMemoryFileResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 * Write memory file
 */
export const writeMemoryFile = <ThrowOnError extends boolean = true>(options: Options<WriteMemoryFileData, ThrowOnError>): RequestResult<WriteMemoryFileResponses, WriteMemoryFileErrors, ThrowOnError> => (options.client ?? client).put<WriteMemoryFileResponses, WriteMemoryFileErrors, ThrowOnError>({
    bodySerializer: null,
    responseValidator: relaxedResponseValidator(zWriteMemoryFileResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
...
export const uploadDaemonFile = <ThrowOnError extends boolean = true>(options: Options<UploadDaemonFileData, ThrowOnError>): RequestResult<UploadDaemonFileResponses, UploadDaemonFileErrors, ThrowOnError> => (options.client ?? client).post<UploadDaemonFileResponses, UploadDaemonFileErrors, ThrowOnError>({
    bodySerializer: null,
    responseValidator: relaxedResponseValidator(zUploadDaemonFileResponse),
    security: [{
            key: 'machineDaemonAuth',
            scheme: 'bearer',
            type: 'http'
