...
import type { AcceptChannelConnectorControlEventData, AcceptChannelConnectorControlEventErrors, AcceptChannelConnectorControlEventResponses, AcceptChannelConnectorEventData, AcceptChannelConnectorEventErrors, AcceptChannelConnectorEventResponses, AcceptChannelConnectorRuntimeEventData, AcceptChannelConnectorRuntimeEventErrors, AcceptChannelConnectorRuntimeEventResponses, AcceptInvitationData, AcceptInvitationErrors, AcceptInvitationResponses, ArchiveAgentData, ArchiveAgentErrors, ArchiveAgentResponses, AttachAgentChannelData, AttachAgentChannelErrors, AttachAgentChannelResponses, BootstrapDaemonData, BootstrapDaemonErrors, BootstrapDaemonResponses, CancelAgentData, CancelAgentErrors, CancelAgentResponses, CancelQueuedBacklogInputData, CancelQueuedBacklogInputErrors, CancelQueuedBacklogInputResponses, ClaimChannelConnectorRuntimeUnitsData, ClaimChannelConnectorRuntimeUnitsErrors, ClaimChannelConnectorRuntimeUnitsResponses, ClaimNextChannelConnectorControlEventData, ClaimNextChannelConnectorControlEventErrors, ClaimNextChannelConnectorControlEventResponses, ClaimNextChannelConnectorEventData, ClaimNextChannelConnectorEventErrors, ClaimNextChannelConnectorEventResponses, CompleteChannelConnectorControlEventData, CompleteChannelConnectorControlEventErrors, CompleteChannelConnectorControlEventResponses, CompleteChannelConnectorEventData, CompleteChannelConnectorEventErrors, CompleteChannelConnectorEventResponses, CompleteExternalChannelRequestData, CompleteExternalChannelRequestErrors, CompleteExternalChannelRequestResponses, CompleteGitHubConnectionData, CompleteGitHubConnectionErrors, CompleteGitHubConnectionResponses, ConnectByoMachineData, ConnectByoMachineErrors, ConnectByoMachineResponses, CreateAgentConfigData, CreateAgentConfigErrors, CreateAgentConfigResponses, CreateAgentData, CreateAgentErrors, CreateAgentInputData, CreateAgentInputErrors, CreateAgentInputResponses, CreateAgentProfileData, CreateAgentProfileErrors, CreateAgentProfileResponses, CreateAgentResponses, CreateByoMachineDaemonTokenData, CreateByoMachineDaemonTokenErrors, CreateByoMachineDaemonTokenResponses, CreateConfiguredModelData, CreateConfiguredModelErrors, CreateConfiguredModelResponses, CreateCronTriggerData, CreateCronTriggerErrors, CreateCronTriggerResponses, CreateExternalIntegrationInstallData, CreateExternalIntegrationInstallErrors, CreateExternalIntegrationInstallResponses, CreateIntegrationAppData, CreateIntegrationAppErrors, CreateIntegrationAppResponses, CreateIntegrationOAuthSetupData, CreateIntegrationOAuthSetupErrors, CreateIntegrationOAuthSetupResponses, CreateMachineData, CreateMachineErrors, CreateMachinePoolData, CreateMachinePoolErrors, CreateMachinePoolResponses, CreateMachineResponses, CreateModelProviderConfigData, CreateModelProviderConfigErrors, CreateModelProviderConfigResponses, CreateOrganizationData, CreateOrganizationErrors, CreateOrganizationResponses, CreateOrgApiKeyData, CreateOrgApiKeyErrors, CreateOrgApiKeyResponses, CreateOrgInvitationData, CreateOrgInvitationErrors, CreateOrgInvitationResponses, CreatePersonalAccessTokenData, CreatePersonalAccessTokenErrors, CreatePersonalAccessTokenResponses, CreateProjectData, CreateProjectErrors, CreateProjectMachineGrantData, CreateProjectMachineGrantErrors, CreateProjectMachineGrantResponses, CreateProjectMachinePoolGrantData, CreateProjectMachinePoolGrantErrors, CreateProjectMachinePoolGrantResponses, CreateProjectModelGrantData, CreateProjectModelGrantErrors, CreateProjectModelGrantResponses, CreateProjectResponses, CreateSecretData, CreateSecretErrors, CreateSecretGrantData, CreateSecretGrantErrors, CreateSecretGrantResponses, CreateSecretResponses, CreateSecretVersionData, CreateSecretVersionErrors, CreateSecretVersionResponses, CreateSkillData, CreateSkillErrors, CreateSkillGrantData, CreateSkillGrantErrors, CreateSkillGrantResponses, CreateSkillResponses, CreateSlackSetupData, CreateSlackSetupErrors, CreateSlackSetupResponses, DeclineInvitationData, DeclineInvitationErrors, DeclineInvitationResponses, DeleteAgentProfileData, DeleteAgentProfileErrors, DeleteAgentProfileResponses, DeleteConfiguredModelData, DeleteConfiguredModelErrors, DeleteConfiguredModelResponses, DeleteCronTriggerData, DeleteCronTriggerErrors, DeleteCronTriggerResponses, DeleteCurrentUserData, DeleteCurrentUserErrors, DeleteCurrentUserResponses, DeleteIntegrationInstallData, DeleteIntegrationInstallErrors, DeleteIntegrationInstallResponses, DeleteMachineData, DeleteMachineErrors, DeleteMachinePoolData, DeleteMachinePoolErrors, DeleteMachinePoolResponses, DeleteMachineResponses, DeleteModelProviderConfigData, DeleteModelProviderConfigErrors, DeleteModelProviderConfigResponses, DeleteOrganizationData, DeleteOrganizationErrors, DeleteOrganizationResponses, DeleteOrgInvitationData, DeleteOrgInvitationErrors, DeleteOrgInvitationResponses, DeleteProjectData, DeleteProjectErrors, DeleteProjectMachineGrantData, DeleteProjectMachineGrantErrors, DeleteProjectMachineGrantResponses, DeleteProjectMachinePoolGrantData, DeleteProjectMachinePoolGrantErrors, DeleteProjectMachinePoolGrantResponses, DeleteProjectModelGrantData, DeleteProjectModelGrantErrors, DeleteProjectModelGrantResponses, DeleteProjectResponses, DeleteSecretData, DeleteSecretErrors, DeleteSecretGrantData, DeleteSecretGrantErrors, DeleteSecretGrantResponses, DeleteSecretResponses, DeleteSkillData, DeleteSkillErrors, DeleteSkillGrantData, DeleteSkillGrantErrors, DeleteSkillGrantResponses, DeleteSkillResponses, DeliverChannelConnectorInputData, DeliverChannelConnectorInputErrors, DeliverChannelConnectorInputResponses, DeliverChannelConnectorWorkflowData, DeliverChannelConnectorWorkflowErrors, DeliverChannelConnectorWorkflowResponses, DemoteSteeringInputToQueuedData, DemoteSteeringInputToQueuedErrors, DemoteSteeringInputToQueuedResponses, DownloadDaemonArtifactData, DownloadDaemonArtifactErrors, DownloadDaemonArtifactResponses, EndMachineDaemonRuntimeData, EndMachineDaemonRuntimeErrors, EndMachineDaemonRuntimeResponses, GetActorData, GetActorErrors, GetActorResponses, GetAgentChannelData, GetAgentChannelErrors, GetAgentChannelResponses, GetAgentConfigData, GetAgentConfigErrors, GetAgentConfigResponses, GetAgentData, GetAgentErrors, GetAgentProfileData, GetAgentProfileErrors, GetAgentProfileResponses, GetAgentProfileUsageData, GetAgentProfileUsageErrors, GetAgentProfileUsageResponses, GetAgentResponses, GetAgentUsageData, GetAgentUsageErrors, GetAgentUsageResponses, GetArtifactContentData, GetArtifactContentErrors, GetArtifactContentResponses, GetArtifactData, GetArtifactErrors, GetArtifactResponses, GetChannelConnectorAppConfigurationData, GetChannelConnectorAppConfigurationErrors, GetChannelConnectorAppConfigurationResponses, GetChannelConnectorInstallationConfigurationData, GetChannelConnectorInstallationConfigurationErrors, GetChannelConnectorInstallationConfigurationResponses, GetCronTriggerData, GetCronTriggerErrors, GetCronTriggerResponses, GetCurrentUserData, GetCurrentUserErrors, GetCurrentUserResponses, GetDaemonSkillArchiveData, GetDaemonSkillArchiveErrors, GetDaemonSkillArchiveResponses, GetIntegrationAppData, GetIntegrationAppErrors, GetIntegrationAppResponses, GetIntegrationLaunchProfileData, GetIntegrationLaunchProfileErrors, GetIntegrationLaunchProfileResponses, GetMachineData, GetMachineErrors, GetMachinePoolData, GetMachinePoolErrors, GetMachinePoolResponses, GetMachineResponses, GetModelCatalogData, GetModelCatalogErrors, GetModelCatalogResponses, GetModelProviderConfigData, GetModelProviderConfigErrors, GetModelProviderConfigResponses, GetOrgApiKeyData, GetOrgApiKeyErrors, GetOrgApiKeyResponses, GetOrgOverviewData, GetOrgOverviewErrors, GetOrgOverviewResponses, GetOrgUsageData, GetOrgUsageErrors, GetOrgUsageResponses, GetProjectAvailableSecretData, GetProjectAvailableSecretErrors, GetProjectAvailableSecretResponses, GetProjectMachinePoolGrantData, GetProjectMachinePoolGrantErrors, GetProjectMachinePoolGrantResponses, GetProjectUsageData, GetProjectUsageErrors, GetProjectUsageResponses, GetSecretData, GetSecretErrors, GetSecretResponses, GetSkillData, GetSkillErrors, GetSkillResponses, GetToolCatalogData, GetToolCatalogErrors, GetToolCatalogResponses, HeartbeatChannelConnectorRuntimeUnitData, HeartbeatChannelConnectorRuntimeUnitErrors, HeartbeatChannelConnectorRuntimeUnitResponses, ListActorsData, ListActorsErrors, ListActorsResponses, ListAgentChannelsData, ListAgentChannelsErrors, ListAgentChannelsResponses, ListAgentInteractionsData, ListAgentInteractionsErrors, ListAgentInteractionsResponses, ListAgentProfilesData, ListAgentProfilesErrors, ListAgentProfilesResponses, ListAgentsData, ListAgentsErrors, ListAgentsResponses, ListByoMachineDaemonTokensData, ListByoMachineDaemonTokensErrors, ListByoMachineDaemonTokensResponses, ListChannelConnectorInstallationControlScopesData, ListChannelConnectorInstallationControlScopesErrors, ListChannelConnectorInstallationControlScopesResponses, ListChannelConnectorRoutesData, ListChannelConnectorRoutesErrors, ListChannelConnectorRoutesResponses, ListConfiguredModelsData, ListConfiguredModelsErrors, ListConfiguredModelsResponses, ListCronTriggersData, ListCronTriggersErrors, ListCronTriggersResponses, ListEligibleIntegrationAppsData, ListEligibleIntegrationAppsErrors, ListEligibleIntegrationAppsResponses, ListEventsData, ListEventsErrors, ListEventsResponses, ListExternalChannelRequestsData, ListExternalChannelRequestsErrors, ListExternalChannelRequestsResponses, ListGitHubSetupInstallationsData, ListGitHubSetupInstallationsErrors, ListGitHubSetupInstallationsResponses, ListGitHubSetupRepositoriesData, ListGitHubSetupRepositoriesErrors, ListGitHubSetupRepositoriesResponses, ListIntegrationAppsData, ListIntegrationAppsErrors, ListIntegrationAppsResponses, ListIntegrationInstallsData, ListIntegrationInstallsErrors, ListIntegrationInstallsResponses, ListMachinePoolsData, ListMachinePoolsErrors, ListMachinePoolsResponses, ListMcpServersData, ListMcpServersErrors, ListMcpServersResponses, ListMcpServerToolsData, ListMcpServerToolsErrors, ListMcpServerToolsResponses, ListMemberProjectAccessData, ListMemberProjectAccessErrors, ListMemberProjectAccessResponses, ListModelProviderConfigsData, ListModelProviderConfigsErrors, ListModelProviderConfigsResponses, ListOrganizationsData, ListOrganizationsErrors, ListOrganizationsResponses, ListOrgApiKeyProjectAccessData, ListOrgApiKeyProjectAccessErrors, ListOrgApiKeyProjectAccessResponses, ListOrgApiKeysData, ListOrgApiKeysErrors, ListOrgApiKeysResponses, ListOrgInvitationsData, ListOrgInvitationsErrors, ListOrgInvitationsResponses, ListOrgMembersData, ListOrgMembersErrors, ListOrgMembersResponses, ListPendingInvitationsData, ListPendingInvitationsErrors, ListPendingInvitationsResponses, ListPersonalAccessTokensData, ListPersonalAccessTokensErrors, ListPersonalAccessTokensResponses, ListProjectAvailableSecretsData, ListProjectAvailableSecretsErrors, ListProjectAvailableSecretsResponses, ListProjectAvailableSkillsData, ListProjectAvailableSkillsErrors, ListProjectAvailableSkillsResponses, ListProjectMachineGrantsData, ListProjectMachineGrantsErrors, ListProjectMachineGrantsResponses, ListProjectMachinePoolGrantsData, ListProjectMachinePoolGrantsErrors, ListProjectMachinePoolGrantsResponses, ListProjectModelGrantsData, ListProjectModelGrantsErrors, ListProjectModelGrantsResponses, ListQueuedBacklogInputsData, ListQueuedBacklogInputsErrors, ListQueuedBacklogInputsResponses, ListRegisteredChannelsData, ListRegisteredChannelsErrors, ListRegisteredChannelsResponses, ListSecretGrantsData, ListSecretGrantsErrors, ListSecretGrantsResponses, ListSecretsData, ListSecretsErrors, ListSecretsResponses, ListSkillGrantsData, ListSkillGrantsErrors, ListSkillGrantsResponses, ListSkillsData, ListSkillsErrors, ListSkillsResponses, ListToolCallsData, ListToolCallsErrors, ListToolCallsResponses, ListTurnEventsData, ListTurnEventsErrors, ListTurnEventsResponses, ListTurnsData, ListTurnsErrors, ListTurnsResponses, ListVisibleMachinesData, ListVisibleMachinesErrors, ListVisibleMachinesResponses, ListVisibleProjectMachinesData, ListVisibleProjectMachinesErrors, ListVisibleProjectMachinesResponses, ListVisibleProjectsData, ListVisibleProjectsErrors, ListVisibleProjectsResponses, LookupChannelConnectorGitHubReviewsData, LookupChannelConnectorGitHubReviewsErrors, LookupChannelConnectorGitHubReviewsResponses, LookupChannelConnectorRecipientsData, LookupChannelConnectorRecipientsErrors, LookupChannelConnectorRecipientsResponses, LookupChannelConnectorWorkflowData, LookupChannelConnectorWorkflowErrors, LookupChannelConnectorWorkflowResponses, MoveQueuedBacklogInputData, MoveQueuedBacklogInputErrors, MoveQueuedBacklogInputResponses, PromoteQueuedInputToSteeringData, PromoteQueuedInputToSteeringErrors, PromoteQueuedInputToSteeringResponses, PublishChannelConnectorDefinitionData, PublishChannelConnectorDefinitionErrors, PublishChannelConnectorDefinitionResponses, PublishExternalChannelDefinitionData, PublishExternalChannelDefinitionErrors, PublishExternalChannelDefinitionResponses, PutActorData, PutActorErrors, PutActorResponses, RecordChannelConnectorGitHubReviewData, RecordChannelConnectorGitHubReviewErrors, RecordChannelConnectorGitHubReviewResponses, RecordMachineFailureData, RecordMachineFailureErrors, RecordMachineFailureResponses, RegisterChannelData, RegisterChannelErrors, RegisterChannelResponses, RegisterMachineDaemonRuntimeData, RegisterMachineDaemonRuntimeErrors, RegisterMachineDaemonRuntimeResponses, ReleaseChannelConnectorRuntimeUnitData, ReleaseChannelConnectorRuntimeUnitErrors, ReleaseChannelConnectorRuntimeUnitResponses, RemoveMemberProjectAccessData, RemoveMemberProjectAccessErrors, RemoveMemberProjectAccessResponses, RemoveOrgApiKeyProjectRoleData, RemoveOrgApiKeyProjectRoleErrors, RemoveOrgApiKeyProjectRoleResponses, RemoveOrgMemberData, RemoveOrgMemberErrors, RemoveOrgMemberResponses, RenameAgentProfileData, RenameAgentProfileErrors, RenameAgentProfileResponses, ResolveAgentInteractionData, ResolveAgentInteractionErrors, ResolveAgentInteractionResponses, ResolveChannelConnectorInstallationConfigurationData, ResolveChannelConnectorInstallationConfigurationErrors, ResolveChannelConnectorInstallationConfigurationResponses, ResolveChannelConnectorInteractionData, ResolveChannelConnectorInteractionErrors, ResolveChannelConnectorInteractionResponses, ResolveChannelConnectorRuntimeInteractionData, ResolveChannelConnectorRuntimeInteractionErrors, ResolveChannelConnectorRuntimeInteractionResponses, RevokeAgentChannelBindingData, RevokeAgentChannelBindingErrors, RevokeAgentChannelBindingResponses, RevokeMachineDaemonTokenData, RevokeMachineDaemonTokenErrors, RevokeMachineDaemonTokenResponses, RevokeOrgApiKeyData, RevokeOrgApiKeyErrors, RevokeOrgApiKeyResponses, RevokePersonalAccessTokenData, RevokePersonalAccessTokenErrors, RevokePersonalAccessTokenResponses, SetChannelConnectorInstallationProviderStateData, SetChannelConnectorInstallationProviderStateErrors, SetChannelConnectorInstallationProviderStateResponses, SetIntegrationLaunchProfileData, SetIntegrationLaunchProfileErrors, SetIntegrationLaunchProfileResponses, SetMemberProjectAccessData, SetMemberProjectAccessErrors, SetMemberProjectAccessResponses, SetOrgApiKeyProjectRoleData, SetOrgApiKeyProjectRoleErrors, SetOrgApiKeyProjectRoleResponses, SleepMachineDaemonRuntimeData, SleepMachineDaemonRuntimeErrors, SleepMachineDaemonRuntimeResponses, SocketMachineDaemonRuntimeData, SocketMachineDaemonRuntimeErrors, StartIntegrationConnectionData, StartIntegrationConnectionErrors, StartIntegrationConnectionResponses, StartSecretMcpoAuthData, StartSecretMcpoAuthErrors, StartSecretMcpoAuthResponses, StreamEventsData, StreamEventsErrors, StreamEventsResponse, StreamEventsResponses, SubmitToolCallResultData, SubmitToolCallResultErrors, SubmitToolCallResultResponses, UpdateAgentConfigData, UpdateAgentConfigErrors, UpdateAgentConfigResponses, UpdateAgentProfileData, UpdateAgentProfileErrors, UpdateAgentProfileResponses, UpdateConfiguredModelData, UpdateConfiguredModelErrors, UpdateConfiguredModelResponses, UpdateCronTriggerData, UpdateCronTriggerErrors, UpdateCronTriggerResponses, UpdateIntegrationAppData, UpdateIntegrationAppErrors, UpdateIntegrationAppResponses, UpdateMachineData, UpdateMachineErrors, UpdateMachinePoolData, UpdateMachinePoolErrors, UpdateMachinePoolResponses, UpdateMachineResponses, UpdateModelProviderConfigData, UpdateModelProviderConfigErrors, UpdateModelProviderConfigResponses, UpdateOrgApiKeyData, UpdateOrgApiKeyErrors, UpdateOrgApiKeyResponses, UpdateOrgMemberData, UpdateOrgMemberErrors, UpdateOrgMemberResponses, UpdateProjectMachinePoolGrantData, UpdateProjectMachinePoolGrantErrors, UpdateProjectMachinePoolGrantResponses, UpdateProjectModelGrantData, UpdateProjectModelGrantErrors, UpdateProjectModelGrantResponses, UpdateSecretData, UpdateSecretErrors, UpdateSecretResponses, UpdateSkillData, UpdateSkillErrors, UpdateSkillResponses, UploadDaemonArtifactData, UploadDaemonArtifactErrors, UploadDaemonArtifactResponses } from './types.gen';
import { zAcceptChannelConnectorControlEventResponse, zAcceptChannelConnectorEventResponse, zAcceptChannelConnectorRuntimeEventResponse, zAcceptInvitationResponse, zArchiveAgentResponse, zAttachAgentChannelResponse, zBootstrapDaemonResponse2, zCancelAgentResponse2, zCancelQueuedBacklogInputResponse, zClaimChannelConnectorRuntimeUnitsResponse, zClaimNextChannelConnectorControlEventResponse, zClaimNextChannelConnectorEventResponse, zCompleteChannelConnectorControlEventResponse, zCompleteChannelConnectorEventResponse, zCompleteExternalChannelRequestResponse2, zCompleteGitHubConnectionResponse, zConnectByoMachineResponse2, zCreateAgentConfigResponse, zCreateAgentInputResponse, zCreateAgentProfileResponse, zCreateAgentResponse, zCreateByoMachineDaemonTokenResponse, zCreateConfiguredModelResponse, zCreateCronTriggerResponse, zCreateExternalIntegrationInstallResponse, zCreateIntegrationAppResponse, zCreateIntegrationOAuthSetupResponse, zCreateMachinePoolResponse, zCreateMachineResponse, zCreateModelProviderConfigResponse2, zCreateOrganizationResponse2, zCreateOrgApiKeyResponse2, zCreateOrgInvitationResponse, zCreatePersonalAccessTokenResponse2, zCreateProjectMachineGrantResponse2, zCreateProjectMachinePoolGrantResponse, zCreateProjectModelGrantResponse, zCreateProjectResponse, zCreateSecretGrantResponse, zCreateSecretResponse, zCreateSecretVersionResponse, zCreateSkillGrantResponse, zCreateSkillResponse, zCreateSlackSetupResponse, zDeclineInvitationResponse, zDeleteAgentProfileResponse, zDeleteConfiguredModelResponse, zDeleteCronTriggerResponse, zDeleteCurrentUserResponse, zDeleteIntegrationInstallResponse, zDeleteMachinePoolResponse, zDeleteMachineResponse, zDeleteModelProviderConfigResponse, zDeleteOrganizationResponse, zDeleteOrgInvitationResponse, zDeleteProjectMachineGrantResponse, zDeleteProjectMachinePoolGrantResponse, zDeleteProjectModelGrantResponse, zDeleteProjectResponse, zDeleteSecretGrantResponse, zDeleteSecretResponse, zDeleteSkillGrantResponse, zDeleteSkillResponse, zDeliverChannelConnectorInputResponse, zDeliverChannelConnectorWorkflowResponse, zDemoteSteeringInputToQueuedResponse, zDownloadDaemonArtifactResponse, zEndMachineDaemonRuntimeResponse, zGetActorResponse, zGetAgentChannelResponse, zGetAgentConfigResponse, zGetAgentProfileResponse, zGetAgentProfileUsageResponse, zGetAgentResponse2, zGetAgentUsageResponse, zGetArtifactContentResponse, zGetArtifactResponse, zGetChannelConnectorAppConfigurationResponse, zGetChannelConnectorInstallationConfigurationResponse, zGetCronTriggerResponse, zGetCurrentUserResponse, zGetDaemonSkillArchiveResponse, zGetIntegrationAppResponse, zGetIntegrationLaunchProfileResponse, zGetMachinePoolResponse, zGetMachineResponse, zGetModelCatalogResponse, zGetModelProviderConfigResponse, zGetOrgApiKeyResponse, zGetOrgOverviewResponse, zGetOrgUsageResponse, zGetProjectAvailableSecretResponse, zGetProjectMachinePoolGrantResponse, zGetProjectUsageResponse, zGetSecretResponse, zGetSkillResponse, zGetToolCatalogResponse, zHeartbeatChannelConnectorRuntimeUnitResponse, zListActorsResponse2, zListAgentChannelsResponse2, zListAgentInteractionsResponse2, zListAgentProfilesResponse2, zListAgentsResponse2, zListByoMachineDaemonTokensResponse, zListChannelConnectorInstallationControlScopesResponse2, zListChannelConnectorRoutesResponse2, zListConfiguredModelsResponse, zListCronTriggersResponse2, zListEligibleIntegrationAppsResponse, zListEventsResponse, zListExternalChannelRequestsResponse2, zListGitHubSetupInstallationsResponse, zListGitHubSetupRepositoriesResponse, zListIntegrationAppsResponse2, zListIntegrationInstallsResponse2, zListMachinePoolsResponse2, zListMcpServersResponse2, zListMcpServerToolsResponse, zListMemberProjectAccessResponse, zListModelProviderConfigsResponse, zListOrganizationsResponse2, zListOrgApiKeyProjectAccessResponse, zListOrgApiKeysResponse2, zListOrgInvitationsResponse2, zListOrgMembersResponse2, zListPendingInvitationsResponse, zListPersonalAccessTokensResponse2, zListProjectAvailableSecretsResponse, zListProjectAvailableSkillsResponse, zListProjectMachineGrantsResponse2, zListProjectMachinePoolGrantsResponse2, zListProjectModelGrantsResponse2, zListQueuedBacklogInputsResponse, zListRegisteredChannelsResponse2, zListSecretGrantsResponse2, zListSecretsResponse2, zListSkillGrantsResponse2, zListSkillsResponse2, zListToolCallsResponse2, zListTurnEventsResponse2, zListTurnsResponse, zListVisibleMachinesResponse2, zListVisibleProjectMachinesResponse, zListVisibleProjectsResponse, zLookupChannelConnectorGitHubReviewsResponse2, zLookupChannelConnectorRecipientsResponse2, zLookupChannelConnectorWorkflowResponse2, zMoveQueuedBacklogInputResponse, zPromoteQueuedInputToSteeringResponse, zPublishChannelConnectorDefinitionResponse, zPublishExternalChannelDefinitionResponse, zPutActorResponse, zRecordChannelConnectorGitHubReviewResponse2, zRecordMachineFailureResponse, zRegisterChannelResponse, zRegisterMachineDaemonRuntimeResponse, zReleaseChannelConnectorRuntimeUnitResponse, zRemoveMemberProjectAccessResponse, zRemoveOrgApiKeyProjectRoleResponse, zRemoveOrgMemberResponse, zRenameAgentProfileResponse, zResolveAgentInteractionResponse, zResolveChannelConnectorInstallationConfigurationResponse, zResolveChannelConnectorInteractionResponse2, zResolveChannelConnectorRuntimeInteractionResponse, zRevokeAgentChannelBindingResponse, zRevokeMachineDaemonTokenResponse, zRevokeOrgApiKeyResponse, zRevokePersonalAccessTokenResponse, zSetChannelConnectorInstallationProviderStateResponse2, zSetIntegrationLaunchProfileResponse, zSetMemberProjectAccessResponse, zSetOrgApiKeyProjectRoleResponse, zSleepMachineDaemonRuntimeResponse, zStartIntegrationConnectionResponse, zStartSecretMcpoAuthResponse, zStreamEventsResponse, zSubmitToolCallResultResponse2, zUpdateAgentConfigResponse2, zUpdateAgentProfileResponse, zUpdateConfiguredModelResponse, zUpdateCronTriggerResponse, zUpdateIntegrationAppResponse, zUpdateMachinePoolResponse, zUpdateMachineResponse, zUpdateModelProviderConfigResponse, zUpdateOrgApiKeyResponse, zUpdateOrgMemberResponse, zUpdateProjectMachinePoolGrantResponse, zUpdateProjectModelGrantResponse, zUpdateSecretResponse, zUpdateSkillResponse, zUploadDaemonArtifactResponse } from './zod.gen';
 ...
 * Delete secret
 *
 * Deletes the secret and permanently destroys all of its versions and project grants; the ciphertext cannot be recovered. Deletion is blocked while the secret is referenced by a model provider config, machine pool, integration app registration, or integration install.
 */
 ...
 */
export const listIntegrationApps = <ThrowOnError extends boolean = true>(options: Options<ListIntegrationAppsData, ThrowOnError>): RequestResult<ListIntegrationAppsResponses, ListIntegrationAppsErrors, ThrowOnError> => (options.client ?? client).get<ListIntegrationAppsResponses, ListIntegrationAppsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListIntegrationAppsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const createIntegrationApp = <ThrowOnError extends boolean = true>(options: Options<CreateIntegrationAppData, ThrowOnError>): RequestResult<CreateIntegrationAppResponses, CreateIntegrationAppErrors, ThrowOnError> => (options.client ?? client).post<CreateIntegrationAppResponses, CreateIntegrationAppErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateIntegrationAppResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const getIntegrationApp = <ThrowOnError extends boolean = true>(options: Options<GetIntegrationAppData, ThrowOnError>): RequestResult<GetIntegrationAppResponses, GetIntegrationAppErrors, ThrowOnError> => (options.client ?? client).get<GetIntegrationAppResponses, GetIntegrationAppErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetIntegrationAppResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const updateIntegrationApp = <ThrowOnError extends boolean = true>(options: Options<UpdateIntegrationAppData, ThrowOnError>): RequestResult<UpdateIntegrationAppResponses, UpdateIntegrationAppErrors, ThrowOnError> => (options.client ?? client).patch<UpdateIntegrationAppResponses, UpdateIntegrationAppErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zUpdateIntegrationAppResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const listEligibleIntegrationApps = <ThrowOnError extends boolean = true>(options: Options<ListEligibleIntegrationAppsData, ThrowOnError>): RequestResult<ListEligibleIntegrationAppsResponses, ListEligibleIntegrationAppsErrors, ThrowOnError> => (options.client ?? client).get<ListEligibleIntegrationAppsResponses, ListEligibleIntegrationAppsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListEligibleIntegrationAppsResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const createExternalIntegrationInstall = <ThrowOnError extends boolean = true>(options: Options<CreateExternalIntegrationInstallData, ThrowOnError>): RequestResult<CreateExternalIntegrationInstallResponses, CreateExternalIntegrationInstallErrors, ThrowOnError> => (options.client ?? client).post<CreateExternalIntegrationInstallResponses, CreateExternalIntegrationInstallErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateExternalIntegrationInstallResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const publishExternalChannelDefinition = <ThrowOnError extends boolean = true>(options: Options<PublishExternalChannelDefinitionData, ThrowOnError>): RequestResult<PublishExternalChannelDefinitionResponses, PublishExternalChannelDefinitionErrors, ThrowOnError> => (options.client ?? client).post<PublishExternalChannelDefinitionResponses, PublishExternalChannelDefinitionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zPublishExternalChannelDefinitionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 *
 * Lists project-owned addresses in this connection, including channels with no agent bindings. Requires project read access. Does not read provider messages or grant access to an agent. Ordered by created_at descending, then id descending.
 */
export const listRegisteredChannels = <ThrowOnError extends boolean = true>(options: Options<ListRegisteredChannelsData, ThrowOnError>): RequestResult<ListRegisteredChannelsResponses, ListRegisteredChannelsErrors, ThrowOnError> => (options.client ?? client).get<ListRegisteredChannelsResponses, ListRegisteredChannelsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListRegisteredChannelsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 * Register a channel
 *
 * Requires project management. External connections accept a customer-defined address; managed connections resolve a provider address through the gateway. Registers an address without creating or granting access to an agent. Repeating an address preserves its ID. Definition and parent identity remain immutable; managed resolution preserves an existing address with no recorded parent.
 */
export const registerChannel = <ThrowOnError extends boolean = true>(options: Options<RegisterChannelData, ThrowOnError>): RequestResult<RegisterChannelResponses, RegisterChannelErrors, ThrowOnError> => (options.client ?? client).post<RegisterChannelResponses, RegisterChannelErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zRegisterChannelResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const attachAgentChannel = <ThrowOnError extends boolean = true>(options: Options<AttachAgentChannelData, ThrowOnError>): RequestResult<AttachAgentChannelResponses, AttachAgentChannelErrors, ThrowOnError> => (options.client ?? client).post<AttachAgentChannelResponses, AttachAgentChannelErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zAttachAgentChannelResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const revokeAgentChannelBinding = <ThrowOnError extends boolean = true>(options: Options<RevokeAgentChannelBindingData, ThrowOnError>): RequestResult<RevokeAgentChannelBindingResponses, RevokeAgentChannelBindingErrors, ThrowOnError> => (options.client ?? client).delete<RevokeAgentChannelBindingResponses, RevokeAgentChannelBindingErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zRevokeAgentChannelBindingResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const listAgentChannels = <ThrowOnError extends boolean = true>(options: Options<ListAgentChannelsData, ThrowOnError>): RequestResult<ListAgentChannelsResponses, ListAgentChannelsErrors, ThrowOnError> => (options.client ?? client).get<ListAgentChannelsResponses, ListAgentChannelsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListAgentChannelsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const getAgentChannel = <ThrowOnError extends boolean = true>(options: Options<GetAgentChannelData, ThrowOnError>): RequestResult<GetAgentChannelResponses, GetAgentChannelErrors, ThrowOnError> => (options.client ?? client).get<GetAgentChannelResponses, GetAgentChannelErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetAgentChannelResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const listExternalChannelRequests = <ThrowOnError extends boolean = true>(options: Options<ListExternalChannelRequestsData, ThrowOnError>): RequestResult<ListExternalChannelRequestsResponses, ListExternalChannelRequestsErrors, ThrowOnError> => (options.client ?? client).get<ListExternalChannelRequestsResponses, ListExternalChannelRequestsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListExternalChannelRequestsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const completeExternalChannelRequest = <ThrowOnError extends boolean = true>(options: Options<CompleteExternalChannelRequestData, ThrowOnError>): RequestResult<CompleteExternalChannelRequestResponses, CompleteExternalChannelRequestErrors, ThrowOnError> => (options.client ?? client).post<CompleteExternalChannelRequestResponses, CompleteExternalChannelRequestErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCompleteExternalChannelRequestResponse2),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 *
 * Retires the install, its routes, targets, agent-channel bindings, and persistent runtimes. Agents and profiles are retained. This uninstalls on the Omnara side only: credentials already issued by the provider are not revoked and provider-side webhooks are not removed.
 */
...
/**
 * Get the profile for future integration launches
 */
export const getIntegrationLaunchProfile = <ThrowOnError extends boolean = true>(options: Options<GetIntegrationLaunchProfileData, ThrowOnError>): RequestResult<GetIntegrationLaunchProfileResponses, GetIntegrationLaunchProfileErrors, ThrowOnError> => (options.client ?? client).get<GetIntegrationLaunchProfileResponses, GetIntegrationLaunchProfileErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetIntegrationLaunchProfileResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Set the profile for future integration launches
 *
 * Changes future agents created by the built-in integration behavior. Existing conversation agents and channel bindings are preserved. Null disables new launches while keeping existing replies working.
 */
export const setIntegrationLaunchProfile = <ThrowOnError extends boolean = true>(options: Options<SetIntegrationLaunchProfileData, ThrowOnError>): RequestResult<SetIntegrationLaunchProfileResponses, SetIntegrationLaunchProfileErrors, ThrowOnError> => (options.client ?? client).put<SetIntegrationLaunchProfileResponses, SetIntegrationLaunchProfileErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zSetIntegrationLaunchProfileResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const startIntegrationConnection = <ThrowOnError extends boolean = true>(options: Options<StartIntegrationConnectionData, ThrowOnError>): RequestResult<StartIntegrationConnectionResponses, StartIntegrationConnectionErrors, ThrowOnError> => (options.client ?? client).post<StartIntegrationConnectionResponses, StartIntegrationConnectionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zStartIntegrationConnectionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const listGitHubSetupInstallations = <ThrowOnError extends boolean = true>(options: Options<ListGitHubSetupInstallationsData, ThrowOnError>): RequestResult<ListGitHubSetupInstallationsResponses, ListGitHubSetupInstallationsErrors, ThrowOnError> => (options.client ?? client).get<ListGitHubSetupInstallationsResponses, ListGitHubSetupInstallationsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListGitHubSetupInstallationsResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const listGitHubSetupRepositories = <ThrowOnError extends boolean = true>(options: Options<ListGitHubSetupRepositoriesData, ThrowOnError>): RequestResult<ListGitHubSetupRepositoriesResponses, ListGitHubSetupRepositoriesErrors, ThrowOnError> => (options.client ?? client).get<ListGitHubSetupRepositoriesResponses, ListGitHubSetupRepositoriesErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListGitHubSetupRepositoriesResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const completeGitHubConnection = <ThrowOnError extends boolean = true>(options: Options<CompleteGitHubConnectionData, ThrowOnError>): RequestResult<CompleteGitHubConnectionResponses, CompleteGitHubConnectionErrors, ThrowOnError> => (options.client ?? client).post<CompleteGitHubConnectionResponses, CompleteGitHubConnectionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCompleteGitHubConnectionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
...
/**
 * Get one connector-scoped provider app configuration
 */
export const getChannelConnectorAppConfiguration = <ThrowOnError extends boolean = true>(options: Options<GetChannelConnectorAppConfigurationData, ThrowOnError>): RequestResult<GetChannelConnectorAppConfigurationResponses, GetChannelConnectorAppConfigurationErrors, ThrowOnError> => (options.client ?? client).get<GetChannelConnectorAppConfigurationResponses, GetChannelConnectorAppConfigurationErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetChannelConnectorAppConfigurationResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
        }],
...
/**
 * Discover live and provider-disabled connections for one app and tenant
 */
export const listChannelConnectorInstallationControlScopes = <ThrowOnError extends boolean = true>(options: Options<ListChannelConnectorInstallationControlScopesData, ThrowOnError>): RequestResult<ListChannelConnectorInstallationControlScopesResponses, ListChannelConnectorInstallationControlScopesErrors, ThrowOnError> => (options.client ?? client).get<ListChannelConnectorInstallationControlScopesResponses, ListChannelConnectorInstallationControlScopesErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListChannelConnectorInstallationControlScopesResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Apply a revision-fenced provider availability observation
 *
 * Applies only to an existing nondeleted managed installation under a live app and project. Does not restore deleted resources, revoked grants or terminal work. Read provider state after reading the expected revisions. On conflict, reread both core and provider state. Every accepted observation advances the installation revision, including unchanged state.
 */
export const setChannelConnectorInstallationProviderState = <ThrowOnError extends boolean = true>(options: Options<SetChannelConnectorInstallationProviderStateData, ThrowOnError>): RequestResult<SetChannelConnectorInstallationProviderStateResponses, SetChannelConnectorInstallationProviderStateErrors, ThrowOnError> => (options.client ?? client).post<SetChannelConnectorInstallationProviderStateResponses, SetChannelConnectorInstallationProviderStateErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zSetChannelConnectorInstallationProviderStateResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Get one installation configuration by internal identity
 */
export const getChannelConnectorInstallationConfiguration = <ThrowOnError extends boolean = true>(options: Options<GetChannelConnectorInstallationConfigurationData, ThrowOnError>): RequestResult<GetChannelConnectorInstallationConfigurationResponses, GetChannelConnectorInstallationConfigurationErrors, ThrowOnError> => (options.client ?? client).get<GetChannelConnectorInstallationConfigurationResponses, GetChannelConnectorInstallationConfigurationErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetChannelConnectorInstallationConfigurationResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const listChannelConnectorRoutes = <ThrowOnError extends boolean = true>(options: Options<ListChannelConnectorRoutesData, ThrowOnError>): RequestResult<ListChannelConnectorRoutesResponses, ListChannelConnectorRoutesErrors, ThrowOnError> => (options.client ?? client).get<ListChannelConnectorRoutesResponses, ListChannelConnectorRoutesErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListChannelConnectorRoutesResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const publishChannelConnectorDefinition = <ThrowOnError extends boolean = true>(options: Options<PublishChannelConnectorDefinitionData, ThrowOnError>): RequestResult<PublishChannelConnectorDefinitionResponses, PublishChannelConnectorDefinitionErrors, ThrowOnError> => (options.client ?? client).post<PublishChannelConnectorDefinitionResponses, PublishChannelConnectorDefinitionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zPublishChannelConnectorDefinitionResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Classify native review observations for one admitted send
 *
 * Exact connector capability and immutable admitted tool scope are required. Historical observations may be recorded after cancellation or disconnect, but confer no new send authority. No native GitHub mutation is performed by this endpoint.
 */
export const lookupChannelConnectorGitHubReviews = <ThrowOnError extends boolean = true>(options: Options<LookupChannelConnectorGitHubReviewsData, ThrowOnError>): RequestResult<LookupChannelConnectorGitHubReviewsResponses, LookupChannelConnectorGitHubReviewsErrors, ThrowOnError> => (options.client ?? client).post<LookupChannelConnectorGitHubReviewsResponses, LookupChannelConnectorGitHubReviewsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zLookupChannelConnectorGitHubReviewsResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Record a native review identity and check creation continuation
 *
 * Exact connector capability and immutable admitted tool scope are required. Historical observations may be recorded after cancellation or disconnect, but confer no new send authority. No native GitHub mutation is performed by this endpoint.
 */
export const recordChannelConnectorGitHubReview = <ThrowOnError extends boolean = true>(options: Options<RecordChannelConnectorGitHubReviewData, ThrowOnError>): RequestResult<RecordChannelConnectorGitHubReviewResponses, RecordChannelConnectorGitHubReviewErrors, ThrowOnError> => (options.client ?? client).post<RecordChannelConnectorGitHubReviewResponses, RecordChannelConnectorGitHubReviewErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zRecordChannelConnectorGitHubReviewResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const lookupChannelConnectorWorkflow = <ThrowOnError extends boolean = true>(options: Options<LookupChannelConnectorWorkflowData, ThrowOnError>): RequestResult<LookupChannelConnectorWorkflowResponses, LookupChannelConnectorWorkflowErrors, ThrowOnError> => (options.client ?? client).post<LookupChannelConnectorWorkflowResponses, LookupChannelConnectorWorkflowErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zLookupChannelConnectorWorkflowResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const deliverChannelConnectorWorkflow = <ThrowOnError extends boolean = true>(options: Options<DeliverChannelConnectorWorkflowData, ThrowOnError>): RequestResult<DeliverChannelConnectorWorkflowResponses, DeliverChannelConnectorWorkflowErrors, ThrowOnError> => (options.client ?? client).post<DeliverChannelConnectorWorkflowResponses, DeliverChannelConnectorWorkflowErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zDeliverChannelConnectorWorkflowResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const lookupChannelConnectorRecipients = <ThrowOnError extends boolean = true>(options: Options<LookupChannelConnectorRecipientsData, ThrowOnError>): RequestResult<LookupChannelConnectorRecipientsResponses, LookupChannelConnectorRecipientsErrors, ThrowOnError> => (options.client ?? client).post<LookupChannelConnectorRecipientsResponses, LookupChannelConnectorRecipientsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zLookupChannelConnectorRecipientsResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const deliverChannelConnectorInput = <ThrowOnError extends boolean = true>(options: Options<DeliverChannelConnectorInputData, ThrowOnError>): RequestResult<DeliverChannelConnectorInputResponses, DeliverChannelConnectorInputErrors, ThrowOnError> => (options.client ?? client).post<DeliverChannelConnectorInputResponses, DeliverChannelConnectorInputErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zDeliverChannelConnectorInputResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Resolve one installation configuration by provider identity
 */
export const resolveChannelConnectorInstallationConfiguration = <ThrowOnError extends boolean = true>(options: Options<ResolveChannelConnectorInstallationConfigurationData, ThrowOnError>): RequestResult<ResolveChannelConnectorInstallationConfigurationResponses, ResolveChannelConnectorInstallationConfigurationErrors, ThrowOnError> => (options.client ?? client).get<ResolveChannelConnectorInstallationConfigurationResponses, ResolveChannelConnectorInstallationConfigurationErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zResolveChannelConnectorInstallationConfigurationResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const acceptChannelConnectorEvent = <ThrowOnError extends boolean = true>(options: Options<AcceptChannelConnectorEventData, ThrowOnError>): RequestResult<AcceptChannelConnectorEventResponses, AcceptChannelConnectorEventErrors, ThrowOnError> => (options.client ?? client).post<AcceptChannelConnectorEventResponses, AcceptChannelConnectorEventErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zAcceptChannelConnectorEventResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Resolve an agent interaction from a provider channel
 */
export const resolveChannelConnectorInteraction = <ThrowOnError extends boolean = true>(options: Options<ResolveChannelConnectorInteractionData, ThrowOnError>): RequestResult<ResolveChannelConnectorInteractionResponses, ResolveChannelConnectorInteractionErrors, ThrowOnError> => (options.client ?? client).post<ResolveChannelConnectorInteractionResponses, ResolveChannelConnectorInteractionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zResolveChannelConnectorInteractionResponse2),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const acceptChannelConnectorRuntimeEvent = <ThrowOnError extends boolean = true>(options: Options<AcceptChannelConnectorRuntimeEventData, ThrowOnError>): RequestResult<AcceptChannelConnectorRuntimeEventResponses, AcceptChannelConnectorRuntimeEventErrors, ThrowOnError> => (options.client ?? client).post<AcceptChannelConnectorRuntimeEventResponses, AcceptChannelConnectorRuntimeEventErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zAcceptChannelConnectorRuntimeEventResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Resolve an agent interaction from a fenced persistent runtime
 */
export const resolveChannelConnectorRuntimeInteraction = <ThrowOnError extends boolean = true>(options: Options<ResolveChannelConnectorRuntimeInteractionData, ThrowOnError>): RequestResult<ResolveChannelConnectorRuntimeInteractionResponses, ResolveChannelConnectorRuntimeInteractionErrors, ThrowOnError> => (options.client ?? client).post<ResolveChannelConnectorRuntimeInteractionResponses, ResolveChannelConnectorRuntimeInteractionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zResolveChannelConnectorRuntimeInteractionResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const claimNextChannelConnectorEvent = <ThrowOnError extends boolean = true>(options: Options<ClaimNextChannelConnectorEventData, ThrowOnError>): RequestResult<ClaimNextChannelConnectorEventResponses, ClaimNextChannelConnectorEventErrors, ThrowOnError> => (options.client ?? client).post<ClaimNextChannelConnectorEventResponses, ClaimNextChannelConnectorEventErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zClaimNextChannelConnectorEventResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 * Durably receive one provider event
 */
export const acceptChannelConnectorControlEvent = <ThrowOnError extends boolean = true>(options: Options<AcceptChannelConnectorControlEventData, ThrowOnError>): RequestResult<AcceptChannelConnectorControlEventResponses, AcceptChannelConnectorControlEventErrors, ThrowOnError> => (options.client ?? client).post<AcceptChannelConnectorControlEventResponses, AcceptChannelConnectorControlEventErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zAcceptChannelConnectorControlEventResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Claim one due app control receipt for an exact connector capability
 *
 * Claims at most one receipt, keeping each response to one bounded event payload. The requested connector_key/provider pair must belong to the authenticated credential. Expired leases can be reclaimed with a new token and generation.
 */
export const claimNextChannelConnectorControlEvent = <ThrowOnError extends boolean = true>(options: Options<ClaimNextChannelConnectorControlEventData, ThrowOnError>): RequestResult<ClaimNextChannelConnectorControlEventResponses, ClaimNextChannelConnectorControlEventErrors, ThrowOnError> => (options.client ?? client).post<ClaimNextChannelConnectorControlEventResponses, ClaimNextChannelConnectorControlEventErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zClaimNextChannelConnectorControlEventResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 *
 * App scope and an exact unexpired lease fence every completion. Yield records strictly forward progress without spending the failure budget. Retry preserves confirmed progress and schedules backoff; transient control work has no total claim ceiling.
 */
export const completeChannelConnectorControlEvent = <ThrowOnError extends boolean = true>(options: Options<CompleteChannelConnectorControlEventData, ThrowOnError>): RequestResult<CompleteChannelConnectorControlEventResponses, CompleteChannelConnectorControlEventErrors, ThrowOnError> => (options.client ?? client).post<CompleteChannelConnectorControlEventResponses, CompleteChannelConnectorControlEventErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCompleteChannelConnectorControlEventResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const completeChannelConnectorEvent = <ThrowOnError extends boolean = true>(options: Options<CompleteChannelConnectorEventData, ThrowOnError>): RequestResult<CompleteChannelConnectorEventResponses, CompleteChannelConnectorEventErrors, ThrowOnError> => (options.client ?? client).post<CompleteChannelConnectorEventResponses, CompleteChannelConnectorEventErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCompleteChannelConnectorEventResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Claim persistent provider runtime units
 */
export const claimChannelConnectorRuntimeUnits = <ThrowOnError extends boolean = true>(options: Options<ClaimChannelConnectorRuntimeUnitsData, ThrowOnError>): RequestResult<ClaimChannelConnectorRuntimeUnitsResponses, ClaimChannelConnectorRuntimeUnitsErrors, ThrowOnError> => (options.client ?? client).post<ClaimChannelConnectorRuntimeUnitsResponses, ClaimChannelConnectorRuntimeUnitsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zClaimChannelConnectorRuntimeUnitsResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Renew a runtime lease and optionally checkpoint it
 */
export const heartbeatChannelConnectorRuntimeUnit = <ThrowOnError extends boolean = true>(options: Options<HeartbeatChannelConnectorRuntimeUnitData, ThrowOnError>): RequestResult<HeartbeatChannelConnectorRuntimeUnitResponses, HeartbeatChannelConnectorRuntimeUnitErrors, ThrowOnError> => (options.client ?? client).post<HeartbeatChannelConnectorRuntimeUnitResponses, HeartbeatChannelConnectorRuntimeUnitErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zHeartbeatChannelConnectorRuntimeUnitResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Release a fenced provider runtime unit
 */
export const releaseChannelConnectorRuntimeUnit = <ThrowOnError extends boolean = true>(options: Options<ReleaseChannelConnectorRuntimeUnitData, ThrowOnError>): RequestResult<ReleaseChannelConnectorRuntimeUnitResponses, ReleaseChannelConnectorRuntimeUnitErrors, ThrowOnError> => (options.client ?? client).post<ReleaseChannelConnectorRuntimeUnitResponses, ReleaseChannelConnectorRuntimeUnitErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zReleaseChannelConnectorRuntimeUnitResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
