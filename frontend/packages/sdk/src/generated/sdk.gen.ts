 ...
 */
export const listIntegrationConnections = <ThrowOnError extends boolean = true>(options: Options<ListIntegrationConnectionsData, ThrowOnError>): RequestResult<ListIntegrationConnectionsResponses, ListIntegrationConnectionsErrors, ThrowOnError> => (options.client ?? client).get<ListIntegrationConnectionsResponses, ListIntegrationConnectionsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListIntegrationConnectionsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const createIntegrationConnection = <ThrowOnError extends boolean = true>(options: Options<CreateIntegrationConnectionData, ThrowOnError>): RequestResult<CreateIntegrationConnectionResponses, CreateIntegrationConnectionErrors, ThrowOnError> => (options.client ?? client).post<CreateIntegrationConnectionResponses, CreateIntegrationConnectionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateIntegrationConnectionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const deleteIntegrationConnection = <ThrowOnError extends boolean = true>(options: Options<DeleteIntegrationConnectionData, ThrowOnError>): RequestResult<DeleteIntegrationConnectionResponses, DeleteIntegrationConnectionErrors, ThrowOnError> => (options.client ?? client).delete<DeleteIntegrationConnectionResponses, DeleteIntegrationConnectionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zDeleteIntegrationConnectionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const getIntegrationConnection = <ThrowOnError extends boolean = true>(options: Options<GetIntegrationConnectionData, ThrowOnError>): RequestResult<GetIntegrationConnectionResponses, GetIntegrationConnectionErrors, ThrowOnError> => (options.client ?? client).get<GetIntegrationConnectionResponses, GetIntegrationConnectionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetIntegrationConnectionResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 * Requires a user principal with project management permission. Personal access tokens, OAuth user tokens, and browser sessions are supported.
 */
export const updateIntegrationConnection = <ThrowOnError extends boolean = true>(options: Options<UpdateIntegrationConnectionData, ThrowOnError>): RequestResult<UpdateIntegrationConnectionResponses, UpdateIntegrationConnectionErrors, ThrowOnError> => (options.client ?? client).put<UpdateIntegrationConnectionResponses, UpdateIntegrationConnectionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zUpdateIntegrationConnectionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const createProjectSlackSetup = <ThrowOnError extends boolean = true>(options: Options<CreateProjectSlackSetupData, ThrowOnError>): RequestResult<CreateProjectSlackSetupResponses, CreateProjectSlackSetupErrors, ThrowOnError> => (options.client ?? client).post<CreateProjectSlackSetupResponses, CreateProjectSlackSetupErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateProjectSlackSetupResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
