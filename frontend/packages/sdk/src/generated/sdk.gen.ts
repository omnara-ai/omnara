 ...
 */
export const claimChannelConnectorDeliveries = <ThrowOnError extends boolean = true>(options: Options<ClaimChannelConnectorDeliveriesData, ThrowOnError>): RequestResult<ClaimChannelConnectorDeliveriesResponses, ClaimChannelConnectorDeliveriesErrors, ThrowOnError> => (options.client ?? client).post<ClaimChannelConnectorDeliveriesResponses, ClaimChannelConnectorDeliveriesErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zClaimChannelConnectorDeliveriesResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const completeChannelConnectorDelivery = <ThrowOnError extends boolean = true>(options: Options<CompleteChannelConnectorDeliveryData, ThrowOnError>): RequestResult<CompleteChannelConnectorDeliveryResponses, CompleteChannelConnectorDeliveryErrors, ThrowOnError> => (options.client ?? client).post<CompleteChannelConnectorDeliveryResponses, CompleteChannelConnectorDeliveryErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCompleteChannelConnectorDeliveryResponse),
    security: [{
            key: 'channelConnectorAuth',
            scheme: 'bearer',
            type: 'http'
