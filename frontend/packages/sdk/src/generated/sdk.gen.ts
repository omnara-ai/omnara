 ...
 */
export const registerExternalChannel = <ThrowOnError extends boolean = true>(options: Options<RegisterExternalChannelData, ThrowOnError>): RequestResult<RegisterExternalChannelResponses, RegisterExternalChannelErrors, ThrowOnError> => (options.client ?? client).post<RegisterExternalChannelResponses, RegisterExternalChannelErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zRegisterExternalChannelResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
