...
/**
 * Get agent model usage
 *
 * Token and cost totals across the agent's model calls. Pass include_children to aggregate over the agent and every subagent beneath it.
 */
