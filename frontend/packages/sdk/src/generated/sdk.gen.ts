 ...
 */
export const createProjectAppSlackSetup = <ThrowOnError extends boolean = true>(options: Options<CreateProjectAppSlackSetupData, ThrowOnError>): RequestResult<CreateProjectAppSlackSetupResponses, CreateProjectAppSlackSetupErrors, ThrowOnError> => (options.client ?? client).post<CreateProjectAppSlackSetupResponses, CreateProjectAppSlackSetupErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateProjectAppSlackSetupResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 *
 * Starts guided registration on github.com for a never-connected GitHub app. Requires a browser session and project management access. Submit manifest as a JSON-encoded form field to registration_url. The callback saves a project credential secret and redirects to the canonical app page with github_setup=credentials_saved and credentials_secret_ref (a public secret ID). It does not connect an installation or change launcher settings.
 */
export const createProjectAppGitHubSetup = <ThrowOnError extends boolean = true>(options: Options<CreateProjectAppGitHubSetupData, ThrowOnError>): RequestResult<CreateProjectAppGitHubSetupResponses, CreateProjectAppGitHubSetupErrors, ThrowOnError> => (options.client ?? client).post<CreateProjectAppGitHubSetupResponses, CreateProjectAppGitHubSetupErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateProjectAppGitHubSetupResponse),
    security: [{
            in: 'cookie',
            name: '__Host-omnara_session',
            type: 'apiKey'
 ...
 *
 * Verifies the supplied project-available GitHub credential secret using App authentication and returns one bounded page of installations. Requires a browser session and project management access. Inspection does not connect or change this app. Explicit confirmation uses ConfigureProjectApp with the returned provider_app_id, selected installation ID, credential secret ID and current expected setup revision. A saved secret remains usable while organization approval is pending; there is no expiring continuation. Guided links support github.com only.
 */
export const inspectProjectAppGitHubInstallations = <ThrowOnError extends boolean = true>(options: Options<InspectProjectAppGitHubInstallationsData, ThrowOnError>): RequestResult<InspectProjectAppGitHubInstallationsResponses, InspectProjectAppGitHubInstallationsErrors, ThrowOnError> => (options.client ?? client).post<InspectProjectAppGitHubInstallationsResponses, InspectProjectAppGitHubInstallationsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zInspectProjectAppGitHubInstallationsResponse),
    security: [{
            in: 'cookie',
            name: '__Host-omnara_session',
            type: 'apiKey'
 ...
 * List project apps
 */
export const listProjectApps = <ThrowOnError extends boolean = true>(options: Options<ListProjectAppsData, ThrowOnError>): RequestResult<ListProjectAppsResponses, ListProjectAppsErrors, ThrowOnError> => (options.client ?? client).get<ListProjectAppsResponses, ListProjectAppsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListProjectAppsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
 ...
 */
export const createProjectApp = <ThrowOnError extends boolean = true>(options: Options<CreateProjectAppData, ThrowOnError>): RequestResult<CreateProjectAppResponses, CreateProjectAppErrors, ThrowOnError> => (options.client ?? client).post<CreateProjectAppResponses, CreateProjectAppErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateProjectAppResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 * Get project app
 */
export const getProjectApp = <ThrowOnError extends boolean = true>(options: Options<GetProjectAppData, ThrowOnError>): RequestResult<GetProjectAppResponses, GetProjectAppErrors, ThrowOnError> => (options.client ?? client).get<GetProjectAppResponses, GetProjectAppErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetProjectAppResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * List app conversation subscriptions
 *
 * Requires project read permission. Disconnected apps retain their subscriptions and support listing.
 */
export const listAppSubscriptions = <ThrowOnError extends boolean = true>(options: Options<ListAppSubscriptionsData, ThrowOnError>): RequestResult<ListAppSubscriptionsResponses, ListAppSubscriptionsErrors, ThrowOnError> => (options.client ?? client).get<ListAppSubscriptionsResponses, ListAppSubscriptionsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListAppSubscriptionsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Attach an agent to an app conversation
 *
 ...
 */
export const createAppSubscription = <ThrowOnError extends boolean = true>(options: Options<CreateAppSubscriptionData, ThrowOnError>): RequestResult<CreateAppSubscriptionResponses, CreateAppSubscriptionErrors, ThrowOnError> => (options.client ?? client).post<CreateAppSubscriptionResponses, CreateAppSubscriptionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zCreateAppSubscriptionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
...
/**
 * Stop forwarding an app conversation to an agent
 *
 * Requires project management permission. Missing subscriptions are a no-op within an existing app. Disconnected apps support deletion. Sending tools, interaction handlers, and the agent remain available. A selected thread does not launch a replacement agent when forwarding stops; attaching again resumes forwarding with a new subscription ID.
 */
export const deleteAppSubscription = <ThrowOnError extends boolean = true>(options: Options<DeleteAppSubscriptionData, ThrowOnError>): RequestResult<DeleteAppSubscriptionResponses, DeleteAppSubscriptionErrors, ThrowOnError> => (options.client ?? client).delete<DeleteAppSubscriptionResponses, DeleteAppSubscriptionErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zDeleteAppSubscriptionResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const configureProjectApp = <ThrowOnError extends boolean = true>(options: Options<ConfigureProjectAppData, ThrowOnError>): RequestResult<ConfigureProjectAppResponses, ConfigureProjectAppErrors, ThrowOnError> => (options.client ?? client).post<ConfigureProjectAppResponses, ConfigureProjectAppErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zConfigureProjectAppResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const disconnectProjectApp = <ThrowOnError extends boolean = true>(options: Options<DisconnectProjectAppData, ThrowOnError>): RequestResult<DisconnectProjectAppResponses, DisconnectProjectAppErrors, ThrowOnError> => (options.client ?? client).post<DisconnectProjectAppResponses, DisconnectProjectAppErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zDisconnectProjectAppResponse),
    security: [
        {
            key: 'bearerAuth',
            scheme: 'bearer',
 ...
 */
export const listAppDefinitions = <ThrowOnError extends boolean = true>(options: Options<ListAppDefinitionsData, ThrowOnError>): RequestResult<ListAppDefinitionsResponses, ListAppDefinitionsErrors, ThrowOnError> => (options.client ?? client).get<ListAppDefinitionsResponses, ListAppDefinitionsErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zListAppDefinitionsResponse2),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
