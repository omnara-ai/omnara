...
/**
 * Get org overview activity
 *
 * Returns the activity counts backing the web app's overview page: agents created, messages sent, and tokens used across every project whose agents the caller can read. Internal to the web app and subject to change without notice.
 */
export const getOrgOverviewActivity = <ThrowOnError extends boolean = true>(options: Options<GetOrgOverviewActivityData, ThrowOnError>): RequestResult<GetOrgOverviewActivityResponses, GetOrgOverviewActivityErrors, ThrowOnError> => (options.client ?? client).get<GetOrgOverviewActivityResponses, GetOrgOverviewActivityErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetOrgOverviewActivityResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Get org overview usage
 *
 * Returns the usage series backing the web app's overview page: model usage across every project the caller can read, split into hourly or daily intervals and broken down by model, project, or agent profile. Internal to the web app and subject to change without notice.
 */
export const getOrgOverviewUsage = <ThrowOnError extends boolean = true>(options: Options<GetOrgOverviewUsageData, ThrowOnError>): RequestResult<GetOrgOverviewUsageResponses, GetOrgOverviewUsageErrors, ThrowOnError> => (options.client ?? client).get<GetOrgOverviewUsageResponses, GetOrgOverviewUsageErrors, ThrowOnError>({
    responseValidator: relaxedResponseValidator(zGetOrgOverviewUsageResponse),
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
